...
import Exploreclaasesicon from "../icons/exploclassheading-icon";
import Exploreclaasesicon2 from "../icons/exploclass heading-icon2";
import exploreimg1 from "../Images/exploreimg1.png";
import Buttonicon1 from "../icons/button-icon1";
import Buttonicon2 from "../icons/botton-icon2";
  ...
  {/* <div className="flex flex-wrap "> */}
        ...
        <div  className="w-full px-4 h-auto py-4 border rounded-xl opacity-100 shadow-md mb-5">
          <div className="flex justify-between my-2">
            <h1 className="text-subheadingfont font-medium text-peacockblue">Explore Classes</h1>
    ...
    {classData.map((classItem) => (
            <div  key={classItem.id}  className=" w-full  h-auto pb-2 bg-white rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
              ...
              <div className="flex justify-between px-4">
                <ul>
                  <li className="text-blackcolor text-pairagraphfont font-bold">{classItem.title}</li>
                  <li className="text-blackcolor text-pairagraphfont font-medium">{classItem.date}</li>
                </ul>
                <ul>
                  <li className="text-blackcolor text-pairagraphfont font-bold inline-flex items-center  gap-2 w-full justify-end "><span>{classItem.capacity}</span> <span><Threedoticon /></span></li>


                  <li className="text-blackcolor text-pairagraphfont font-medium">{classItem.time}</li>
                </ul>
              </div>
